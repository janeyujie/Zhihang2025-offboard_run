...
# ===================================================================================
# Zhihang2025 无人机双机协同自主搜救任务——北京航空航天大学 郑宇杰、传真奇、张家文、杨佳宇轩
# 仿真与测试任务一键启动脚本
...
echo "🕒 等待30秒，确保 Gazebo 和 PX4 完全启动..."
sleep 30
...
# --- 终端 7: 启动数据记录 ---
echo "➡️ [7/12] 正在新终端中启动 rosbag 数据记录..."
...
# --- 终端 8: 阶段一固定翼控制 ---
echo "➡️ [8/12] 正在新终端中启动阶段一 VTOL 控制脚本..."
...
# --- 终端 10: 阶段二四旋翼控制 ---
echo "➡️ [10/12] 正在新终端中启动阶段二 Iris 控制脚本..."
gnome-terminal -- bash -c "echo '✅ [终端10] Iris 控制脚本 (iris_commander1.py) 启动中...'; cd ~/catkin_ws/src/offboard_run/scripts; python3 iris_commander.py; exec bash"
sleep 2

# --- 终端 11 & 12: 阶段二识别 ---
echo "➡️ [11/12] 正在新终端中启动阶段二识别脚本..."
