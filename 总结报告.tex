...
在控制层面，实现了\textbf{任务规划与控制系统}的一体化设计：
\begin{itemize}
...
训练数据详情请见：\href{https://app.roboflow.com/join/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ3b3Jrc3BhY2VJZCI6IlQ4VGZpZ0FqQkdOMWIzT1pITjNNMUJ3dDNoazIiLCJyb2xlIjoib3duZXIiLCJpbnZpdGVyIjoiaGFpa2U4MjZAZ21haWwuY29tIiwiaWF0IjoxNzUzNjc5NTUzfQ.ksRN2pjtnuXkUIybOxv0PoRmLFUzQssGo_Zjj3tStE0}{Roboflow平台}
在目标定位方面：
\begin{itemize}
    \item 基于\textbf{相机针孔模型}反投影坐标
    \item 使用消息队列进行\textbf{图像帧、相机信息和无人机位姿的严格时空同步}
    \item 确保坐标解算数据的高保真度
\end{itemize}
